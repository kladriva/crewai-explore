    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-lg transition duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="grid grid-cols-3 gap-2 text-xs">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-2 rounded text-center">
                <p className="font-medium text-gray-700 dark:text-gray-300">Viewer</p>
                <p className="text-gray-500">viewer/view123</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-gray-600 dark:text-gray-400 mt-6">
          Powered by CrewAI & GPT-4 • v1.0.0
        </p>
      </div>
    </div>
  );
